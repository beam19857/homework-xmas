...
func Value(v int) predicate.Resolution {
	return predicate.Resolution(func(s *sql.Selector) {
...
func ValueEQ(v int) predicate.Resolution {
	return predicate.Resolution(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldValue), v))
	})
}
...
func ValueNEQ(v int) predicate.Resolution {
	return predicate.Resolution(func(s *sql.Selector) {
...
func ValueIn(vs ...int) predicate.Resolution {
...
func ValueNotIn(vs ...int) predicate.Resolution {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func ValueGT(v int) predicate.Resolution {
	return predicate.Resolution(func(s *sql.Selector) {
...
func ValueGTE(v int) predicate.Resolution {
	return predicate.Resolution(func(s *sql.Selector) {
...
func ValueLT(v int) predicate.Resolution {
	return predicate.Resolution(func(s *sql.Selector) {
...
func ValueLTE(v int) predicate.Resolution {
	return predicate.Resolution(func(s *sql.Selector) {
...
func HasPlaylistVideosWith(preds ...predicate.Playlist_Video) predicate.Resolution {
	return predicate.Resolution(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
